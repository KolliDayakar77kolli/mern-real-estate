            ...
            <Flex direction={{ base: 'column', md: 'row' }} align="center">
              <Box flex={{ base: 'none', md: '1' }}>
                ...
                >
                  {slides.map((slide, index) => (
                    <Image key={index} src={slide.img} alt={slide.title} objectFit="cover" maxH="250px" />
                  ))}
                </Carousel>
              </Box>
              <Box p={4} flex={{ base: 'none', md: '1' }}>
                ...
                <Text mt={4} fontSize="sm" lineHeight="tall">
                  Possimus deserunt nisi perferendis, consequuntur odio et aperiam, est, dicta dolor itaque sunt laborum, magni qui optio.
                </Text>
              </Box>
            </Flex>
          </Box>
