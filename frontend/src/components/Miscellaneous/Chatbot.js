...
//       // Connect to socket.io once chat is started
//       const newSocket = io('http://localhost:5000', {
//         transports: ['websocket'], // Specify the transports you want to allow
//       });
//       setSocket(newSocket);
...
//       console.log('Socket connected'); // Log that the socket is connected
//     } catch (error) {
//       console.error('Error starting new chat:', error);
//     }
//   };
